...
class sensors(object):
		...
		#		print aux2[0]
			...
			pub1=rospy.Publisher('Temperature',String,queue_size=1)
		    	pub1.publish("T"+str(T)+"&")
		    	pub2=rospy.Publisher('Current',String,queue_size=1)
		    	pub2.publish("I"+str(I)+"&")
